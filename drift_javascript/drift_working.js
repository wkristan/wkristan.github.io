...
function drawChart1(data) {
        ...
        var freq_options = {
            title: "Allele frequencies over 100 generations of drift",
            vAxis: {title: "Relative frequency", viewWindowMode: "explicit", viewWindow: {min: 0, max: 1}},
            hAxis: {title: "Generation", viewWindowMode: "explicit", viewWindow: {min: 0, max: 100}},
            pointSize: 1,
            isStacked: "relative",
            pointsVisible: false,
        };
...
// Measure Hz, allele frequencies - record
    ...
    var freq_data = new google.visualization.DataTable();
        ...
        freq_data.addColumn('number', "A: " + alleleFreqs[100][1].toFixed(2));
        freq_data.addColumn('number', "B: " + alleleFreqs[100][2].toFixed(2));
        freq_data.addColumn('number', "C: " + alleleFreqs[100][3].toFixed(2));
        freq_data.addColumn('number', "D: " + alleleFreqs[100][4].toFixed(2));
        freq_data.addColumn('number', "E: " + alleleFreqs[100][5].toFixed(2));
        freq_data.addRows(alleleFreqs);
    
    var het_data = new google.visualization.DataTable();
        het_data.addColumn('number','Generation');
        het_data.addColumn('number','Heterozygosity');
        het_data.addRows(Hz);
