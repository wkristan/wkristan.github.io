...
We can get confidence intervals for a proportion by profiling its likelihood function.

First, find the maximum likelihood estimate of p for a sample of 20 individuals, of which 15 were heterozygous.

#### Question: what is the maximum likelihood estimate for p? Does it match the formula for a proportion (number of heterozygotes/total individuals)?

>

#### Question: the confidence interval for the estimate of p of 0.75 is asymmetrical around 0.75. Why is it a good thing for the confidence interval of a proportion to be asymmetrical?

>

Now find the confidence interval for the maximum likelihood estimate of 0.2, with 4 heterozygotes out of 20 individuals.

#### Question: report lower and upper limits for the 95% confidence interval for p = 0.2 at a sample size of 20. Is this interval also asymmetrical? Which of the two ends (upper or lower) is closer to the estimate?

>

Now, with 20 heterozygotes out of 100 individuals find the 95% confidence interval. The estimate will still be p = 0.2, but the sample size is larger this time.
...
Work with the online app for estimating the mean from the entire data set, and download images into the working folder as instructed (use the first one, that only shows one point at a time along with the calculations of the likelihood given the selected value of the mean to learn how the process works, but there are no images to download or questions to answer here based on it). As long as you download the images with the correct file names they will show up in your knitted output. Answer the questions below based on what you find out in the app.
...
Download the dataset likelihood function graph, and call it mean_ml_dataset.png.
