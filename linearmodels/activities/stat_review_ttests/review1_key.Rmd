...
ggplot(onesample, aes(y = Body.temperature)) + geom_boxplot()
...
ggplot(co2.stacked, aes(x = Uptake)) + geom_dotplot() + facet_wrap(~Treatment, ncol = 1)
...
ggplot(co2.stacked, aes(y = Uptake, x = Treatment)) + geom_boxplot()
...
ggplot(paired, aes(y = diffs)) + geom_boxplot()
